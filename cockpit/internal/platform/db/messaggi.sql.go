...
WHERE ($1::uuid IS NULL OR $1::uuid = ANY (caselle_id))
  AND ($2::text = '' OR quadrante = $2::text)
...
type ContaQuadrantiRow struct {
	Clienti   int64 `json:"clienti"`
	Fornitori int64 `json:"fornitori"`
	Interni   int64 `json:"interni"`
	Altro     int64 `json:"altro"`
...
SELECT messaggio_id, canale, chiave_esterna, conversazione_id, parent_messaggio_id, thread_id, aggancio, agganciato_da, agganciato_il, direzione, data_evento, mittente_nome, mittente_indirizzo, buyer_id, destinatari, oggetto, corpo_testo, corpo_html, lingua, importanza, nota_operatore, n_allegati, registrato_il, registrato_da, interno, controparte_tipo, controparte_cliente_id, controparte_fornitore_id, controparte_via, controparte_il, richiesta_fornitore_id, controparte_altro_id FROM messaggio WHERE messaggio_id = $1
`
...
SELECT messaggio_id, canale, chiave_esterna, conversazione_id, parent_messaggio_id, thread_id, aggancio, agganciato_da, agganciato_il, direzione, data_evento, mittente_nome, mittente_indirizzo, buyer_id, destinatari, oggetto, corpo_testo, corpo_html, lingua, importanza, nota_operatore, n_allegati, registrato_il, registrato_da, interno, controparte_tipo, controparte_cliente_id, controparte_fornitore_id, controparte_via, controparte_il, richiesta_fornitore_id, controparte_altro_id FROM messaggio WHERE canale = $1 AND chiave_esterna = $2
`
...
SELECT messaggio_id, canale, direzione, interno, data_evento, thread_id, aggancio, conversazione_id, mittente_nome, mittente_indirizzo, oggetto, n_allegati, buyer_id, dominio, cliente_id, cliente, buyer_cognome, n_rif_portale, n_cad, triage_esito, triage_confidenza, triage_motivi, thread_proposto, ignorato, caselle, caselle_id, n_caselle, non_letto, ricevuto_il, casella_id, cartella_outlook, entry_id, controparte_tipo, controparte, triage_atto, richiesta_fornitore_id, triage_legame, quadrante FROM v_inbox
WHERE ($1::text = 'tutti'
...
SELECT messaggio_id, canale, chiave_esterna, conversazione_id, parent_messaggio_id, thread_id, aggancio, agganciato_da, agganciato_il, direzione, data_evento, mittente_nome, mittente_indirizzo, buyer_id, destinatari, oggetto, corpo_testo, corpo_html, lingua, importanza, nota_operatore, n_allegati, registrato_il, registrato_da, interno, controparte_tipo, controparte_cliente_id, controparte_fornitore_id, controparte_via, controparte_il, richiesta_fornitore_id, controparte_altro_id FROM messaggio WHERE conversazione_id = $1 ORDER BY data_evento
`
...
SELECT messaggio_id, canale, chiave_esterna, conversazione_id, parent_messaggio_id, thread_id, aggancio, agganciato_da, agganciato_il, direzione, data_evento, mittente_nome, mittente_indirizzo, buyer_id, destinatari, oggetto, corpo_testo, corpo_html, lingua, importanza, nota_operatore, n_allegati, registrato_il, registrato_da, interno, controparte_tipo, controparte_cliente_id, controparte_fornitore_id, controparte_via, controparte_il, richiesta_fornitore_id, controparte_altro_id FROM messaggio WHERE thread_id = $1 ORDER BY data_evento
`
...
RETURNING messaggio_id, canale, chiave_esterna, conversazione_id, parent_messaggio_id, thread_id, aggancio, agganciato_da, agganciato_il, direzione, data_evento, mittente_nome, mittente_indirizzo, buyer_id, destinatari, oggetto, corpo_testo, corpo_html, lingua, importanza, nota_operatore, n_allegati, registrato_il, registrato_da, interno, controparte_tipo, controparte_cliente_id, controparte_fornitore_id, controparte_via, controparte_il, richiesta_fornitore_id, controparte_altro_id, (xmax = 0) AS inserito
`
