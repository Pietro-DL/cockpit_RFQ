...
L1 su `rfq/fascicolo` (il gate, i cicli, la differenza, la classificazione dei nodi, il confronto con la working, l'unione dei codici candidati). L4 per `ingest`, `aggancio`, `registro/fornitori`,
...
candidati e il gesto che aggiunge un codice, B8.6),
