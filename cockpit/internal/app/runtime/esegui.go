// L'avvio del processo: la stessa sequenza di prima, spostata qui dal main.
//
// main.go resta la riga di comando — i flag, la compilazione di Opzioni, il codice di uscita — e
// niente altro: l'ordine in cui il server nasce (config, log, database, semi, capacita', servizi,
// TLS, ascolto) e' una cosa del programma, non del suo involucro, e da qui si puo' leggere e
// provare senza passare da un eseguibile.
//
// In questo passo il corpo e' identico riga per riga a quello che stava in `run`: cambiano solo il
// nome della funzione e i campi di Opzioni, che devono essere esportati perche' ora e' main a
// riempirli da fuori.
